...
const promos = [
  { id: 1, titre: 'Vente Flash Artisanat', reduction: '-30%', prix: '25 000', original: '35 714', description: "Sculptures, masques et mobilier d'exception.", finDate: new Date(Date.now() + 48 * 3600 * 1000).toISOString(), image: 'https://images.unsplash.com/photo-1544208365-d69806b9bba0?auto=format&fit=crop&q=80&w=800', color: '#EF4444', tag: '🔥 FLASH' },
