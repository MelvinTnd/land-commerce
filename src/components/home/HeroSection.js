          ...
          <div className="flex-1 w-full lg:max-w-[480px] relative hidden md:block">
            <div className="relative w-full pl-20">
              ...
              <div className="relative w-full aspect-[4/5] rounded-[40px] overflow-hidden shadow-2xl z-20" style={{ border: '8px solid white' }}>
                ...
                <div className="absolute bottom-6 left-6 bg-white/95 backdrop-blur-sm px-4 py-3 rounded-2xl flex items-center gap-3 shadow-lg">
                  <div className="w-10 h-10 rounded-full bg-[#1B6B3A] text-white flex items-center justify-center shrink-0">
                    <span className="material-symbols-outlined text-[18px]">star</span>
                  </div>
                  <div>
                    <p className="text-[11px] font-extrabold uppercase tracking-widest text-[#111827]">Pièce Unique</p>
                    <p className="text-[10px] text-gray-500 font-bold">Certifié Artisan</p>
                  </div>
                </div>
              </div>

              {/* Badge doré */}
              <div className="absolute -bottom-4 right-0 w-20 h-20 bg-[#EAB308] rounded-full flex items-center justify-center shadow-lg z-30" style={{ border: '4px solid white' }}>
                <span className="material-symbols-outlined text-white text-[26px]">public</span>
              </div>
            </div>
          </div>
